...
RSpec.describe TopicsController, type: :controller do
   ...
   describe "POST create" do
     it "increases the number of topics by 1" do
       ...
       #expect{ post :create, params: {my_topic: {name: RandomData.random_sentence, description: RandomData.random_paragraph}}}.to change(Topic,:count).by(1)
     end
   
     it "assigns Topic.last to @topic" do
       post :create, params: {my_topic: {name: RandomData.random_sentence, description: RandomData.random_paragraph}}
